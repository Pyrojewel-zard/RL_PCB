...
int main(void)
{
    std::string input_file = "./input_files/bistable_oscillator_with_555_timer.pcb";
    std::string output_file_create = "./output_files/bistable_oscillator_with_555_timer.pcb";
    std::string output_file_append = "./output_files/bistable_oscillator_with_555_timer_append.pcb";
