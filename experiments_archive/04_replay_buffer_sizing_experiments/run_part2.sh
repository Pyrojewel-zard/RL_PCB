#!/bin/bash
# This script is used to run the RL_PCB experiments for the paper "Reinforcement Learning for PCB Assembly Scheduling: A Case Study"
...
tensorboard --logdir ./work/ --host 0.0.0.0 --port 6004 &
sleep 2
